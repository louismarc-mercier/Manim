...
class PythagoreanProof(Scene):
    ...
    def construct(self):
        ...
        # Generate the triangles (inside rectangles) of the right square.
        triangles2 = VGroup(*[Polygon(rect[i + 1], rect[i], rect[i - 1], fill_opacity=0.7)
                              for rect in rect_dot for i in [0, 2]])
        ...
        theorem_colors = [ORANGE, BLUE, PINK]
