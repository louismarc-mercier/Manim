...
class GeoArithmInequality(Scene):
    def construct(self):
        ...
        caption_string = r"La moyenne g\'eom\'etrique de $x_{1},x_{2},\dots,x_{n}\in\mathbb{R}$ est inf\'erieure \`a leur moyenne arithm\'etique, c'est-\`a-dire "
        caption_property = TextMobject2(caption_string)
        caption_property.scale(0.75)
        caption_property.move_to(np.array([-0.15,2.1,0]))
