...
class AreaThumbnail(Scene):
    ...
    def construct(self):
        ...
        line1 = TextMobject("Géométrie Euclidienne").scale(1.5).shift(2.25 * UP).set_color(BLUE)
        line2 = TextMobject(r"Aire d'un rectangle").scale(2).next_to(line1, DOWN).set_color(BLUE)
...
class ObjectifLecon(Scene):
    ...
    def construct(self):
        ...
        \begin{itemize}
        \item Connaître la formule de l'aire d'un rectangle,
        \item Calculer l'aire d'un rectangle.
        \end{itemize}
        """)
...
class RectangleDefinition(Scene):
    ...
    def construct(self):
        title = TextMobject(r"\underline{\sc Qu'est-ce qu'un rectangle?}", color=WHITE).to_corner(UL)
        definition = TextMobject(r"""
                    \RedBox[label=exsecond]{}{
                    En géométrie euclidienne, un rectangle est un quadrilatère dont les quatre angles sont droits où 
                    $L,l> 0$ correspondent respectivement à la longueur et la largeur.
                    }      
                """
                )
...
class AreaFormula(Scene):
    ...
    def construct(self):
        title = TextMobject(r"\underline{\sc L'aire d'un rectangle}", color=WHITE).to_corner(UL)
        definition = TextMobject(r"""
                    \RedBox[label=exsecond]{}{
                    Soit un rectangle de longueur $L>0$, de largeur $l>0$ et d'aire $A$. Alors, son aire est le produit 
                    entre sa longueur et sa largeur.
                    \begin{equation}
                    A = L\times l
                    \end{equation}
                    }      
...
class SquareAreaFormula(Scene):
    ...
    def construct(self):
        title = TextMobject(r"\underline{\sc L'aire d'un carré}", color=WHITE).to_corner(UL)
        definition = TextMobject(r"""
                    \RedBox[label=exsecond]{}{
                    Soit un carré de côté $c>0$. Alors, son aire est le carré de sa longueur.
                    \begin{equation}
                    A = c\times c=c^{2}
                    \end{equation}
                    }      
...
class ParticularRectangle(Scene):
    ...
    def pre_square(self):
        ...
        title = TextMobject(r"\sc Calcul d'aire (rectangle, $L=4.1$, $l=2.2$)", color=WHITE).to_corner(UL)
        self.title = VGroup(title)
        ...
        pause = TextMobject("Faites pause et trouvez l'aire du rectangle.").next_to(circ, RIGHT)
        ...
        line1 = TextMobject(r"Aire", " = ", "4.1", "$\\times$", "2.2", " = ", "{}".format(4.1*2.2)). \
        ...
        answer = TextMobject("L'aire du rectangle est de $9.02$ unités carrés.").to_corner(DL)
...
class Conclusion(Scene):
    ...
    def construct(self):
        ...
        compl_rules_str = [
            "",
            "L’aire d'un rectangle est égale au produit de sa longueur et de sa largeur.",
            "L’aire d'un carré est égale à la longueur d'un côté mise au carré.",
        ]
        ...
        self.play(*list(map(DrawBorderThenFill, [right_rectangle, left_rectangle])))
        t_a2 = TexMobject("A=L\\times l", color=WHITE).move_to(left_rectangle)
...
class UnitSquare(Scene):
    ...
    def pre_square(self):
        ...
        title = TextMobject(r"\sc Rappel: carré unité ($c=1$)", color=WHITE).to_corner(UL)
        self.title = VGroup(title)
...
class Proprietes(Scene):
    ...
    def construct(self):
        title = TextMobject(r"\underline{\sc Rappel: Propriétés de l'aire}", color=WHITE).to_corner(UL)
...
class AreaDecomposition(Scene):
    ...
    def pre_square(self):
        ...
        title = TextMobject(r"\sc Rappel (suite): additivité de l'aire", color=WHITE).to_corner(UL)
        self.title = VGroup(title)
        self.play(Write(title, run_time=1), ShowCreation(square, run_time=1),
                  *[GrowFromCenter(object) for object in [*measures_1]], run_time=1
                  )
...
class RectangleDecomposition1(Scene):
    ...
    def pre_square(self):
        ...
        horizontal_measure = MeasureDistance(Line(dl, dr), invertir=True, dashed=True, buff=-0.25).add_tips()\
            .add_tex("2", buff=-3.7, color=WHITE)
        ...
        title = TextMobject(r"\sc Exemple: Calcul d'aire (rectangle, $L=2$, $l=1$)", color=WHITE).to_corner(UL)
        self.title = VGroup(title)
        self.play(Write(title, run_time=1), ShowCreation(rectangle, run_time=1),
                  *[GrowFromCenter(object) for object in [*measures_1]], run_time=1
                  )
    ...
    def pos_square(self):
        ...
        # Pause to think about it.
        answer = TextMobject("L'aire du rectangle est de $2$ unités carrés.").to_corner(DL)
        self.play(Write(answer))
...
class RectangleDecomposition2(Scene):
    ...
    def pre_square(self):
        ...
        horizontal_measure = MeasureDistance(Line(dl, dr), invertir=True, dashed=True, buff=-0.25).add_tips()\
            .add_tex("4", buff=-3.7, color=WHITE)
        vertical_measure = MeasureDistance(Line(dl, ul), invertir=False, dashed=True, buff=0.5).add_tips()\
            .add_tex("2", buff=2, color=WHITE)
        vertical_measure[-1].rotate(-PI/2)
        measures_1 = VGroup(vertical_measure, horizontal_measure)


        title = TextMobject(r"\sc Exemple: Calcul d'aire (rectangle, $L=4$, $l=2$)", color=WHITE).to_corner(UL)
        self.title = VGroup(title)
        self.play(Write(title, run_time=1), ShowCreation(rectangle, run_time=1),
                  *[GrowFromCenter(object) for object in [*measures_1]], run_time=1
                  )
    ...
    def pos_square(self):
        ...
        # Pause to think about it.
        answer = TextMobject("L'aire du rectangle est de $8$ unités carrés.").to_corner(DL)
        self.play(Write(answer))
        self.play(FadeOut(answer), run_time=5)
